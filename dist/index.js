...
var ProvidersContext = /*#__PURE__*/React__default.createContext();
var MultiProvider = function MultiProvider(_ref) {
  var children = _ref.children,
      providers = _ref.providers;
  return /*#__PURE__*/React__default.createElement(ProvidersContext.Provider, {
    value: providers
  }, children);
};
...
var useProvider = function useProvider(name) {
  ...
  var providers = (_useContext = React.useContext(ProvidersContext)) !== null && _useContext !== void 0 ? _useContext : [];
...
var useChange = function useChange(provider, key) {
  ...
  var _useState = React.useState(provider[key]),
